...
export const testimonials: TTestimonial[] = [
  {
    ...
    text: "I employed Jurlina Contractors to clear out debris from my creek boundary which was blocked in many places resulting in two major floods. All rubbish, wood and logs were removed resulting in a good flow of water and less chance of flooding on my property. I highly recommend Nick Jurlina and the team for this work. They are hard working, affordable and professional."
  },
  {
    person: "Havard",
    location: "Kaipara, Auckland",
    text: "Nick Jurlina does a great job at mulching properties and converting them from being overgrown and run down to looking parklike. Over the years, he has attended to all my mulching work. Whether it's scrub, privet or gorse, we highly recommend him for anyone needing tractor mulching!"
  },
  {
    person: "Warwick",
